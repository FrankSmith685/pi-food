            ...
            <div ref={contenedor_mobile} className="bg-gray-800  w-full h-auto p-2 -mt-96 lg:hidden hidden ease-linear transition-all duration-300 -z-50">
                ...
                <div className="space-x-4">
                    <ul className="w-full space-y-1 text-base">
                        ...
                        <li className="w-full py-1 px-2 bg-gray-600 "><Link to="/addActivity"><button className="py-0 px-0 text-gray-400 font-serif font-semibold hover:text-yellow-600 transition duration-300">Add Recipe</button></Link></li>
